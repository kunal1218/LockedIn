...
export default function FriendsPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 pb-6 pt-10">
      <div className="grid grid-cols-[200px_minmax(0,_1fr)] items-start gap-4 lg:gap-6">
        <Card className="flex h-[60vh] min-h-[520px] flex-col overflow-hidden border border-card-border/70 bg-white/80 shadow-sm md:h-[65vh]">
