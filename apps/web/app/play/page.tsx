  ...
  return (
    <div className="mx-auto h-[calc(100vh-80px)] max-w-6xl overflow-hidden px-4 pb-6 pt-6 flex flex-col">
      <div className="relative flex-1">
        <div className="absolute left-6 -top-5 z-20 inline-flex overflow-hidden rounded-t-2xl border border-card-border/70 bg-white/80 shadow-sm">
          <button
            type="button"
      ...
      {activeGame === "covo" ? (
        <Card className="relative grid flex-1 min-h-[520px] grid-rows-[auto_1fr_auto] gap-3 overflow-hidden border border-card-border/70 bg-white/85 pt-10 shadow-sm">
      ...
      {/* Center panel replaces modal for idle/waiting/match-end states */}
        ...
        <Card className="relative flex flex-1 flex-col gap-6 overflow-hidden border border-card-border/70 bg-white/85 pt-10 shadow-sm">
